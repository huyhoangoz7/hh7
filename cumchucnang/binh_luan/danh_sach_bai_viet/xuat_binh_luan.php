...
<?php 
	...
	if($chuc_nang_binh_luan_danh_sach_bai_viet=="bat")
	{
		if($so_binh_luan!=0)
		{
			...
			$tv="select * from binh_luan_lllll where loai_menu='danh_sach_bai_viet' and dia_chi_so='$id_bv' order by id $sx_l limit $vtbd,$so_gioi_han ";
			...
			{
				$lien_ket_xoa_bl_bv="?thamso=xoa_binh_luan_bv&id=".$tv_2['id']."&id_bv=".$id_bv."&trang=".$trang;
