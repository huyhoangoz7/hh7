...
function dem_so_binh_luan_bai_viet_2()
{
	...
	$tv="select * from menu_ngang where id='$id_bv'";
	$tv_1=mysql_query($tv);
			...
			if($tong_so_binh_luan<$so_binh_luan_toi_da)
			{
				...
				if($so_binh_luan_trong_ngay<$so_binh_luan_toi_da_trong_ngay)
				{
					...
					$tv="
						...
						VALUES (NULL, '$noi_dung_binh_luan', 'bai_viet_mot_tin', '$id_bv', '$so_lan_xoa','$ngay_hien_tai');
					";
					...
					$duong_dan="?thamso=xuat_mot_tin_2&id=".$id_bv."&trang=".$st;
					
					if($cach_hien_thi_binh_luan=="moi_truoc_cu_sau")
					{
						$duong_dan="?thamso=xuat_mot_tin_2&id=".$id_bv;
					}
				...
				else 
				{
					...
					$duong_dan="?thamso=xuat_mot_tin_2&id=".$id_bv."&trang=".$trang;
