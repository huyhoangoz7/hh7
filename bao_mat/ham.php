...
<?php 
	...
	function ma_hoa_mktv($c)
	{
		$c=trim($c);
		$c_2="lllll_369987_741923_7lp9mzw__";
		$c=$c_2.$c;
		$kq=md5(sha1(md5(sha1(md5($c)))));
		return $kq;
	}
	...
	function xuat_tu_khoa_bm($c)	
	{

		$bao_mat=new bao_mat;
		$c=strip_tags($c);		
		$c=$bao_mat->thay_the_noi_dung_tu_khoa_tim_kiem($c);
	...
	function yeu_to_session_bm()
	{
		...
		$c="l_".$_SESSION['so_session_ngau_nhien']."_".$c."_lll_ll_";
