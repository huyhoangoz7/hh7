...
?>
<?php 
	$ten_1=lay_thong_so('td_a1');
	$ten_2=lay_thong_so('td_a2');
	$ten_3=lay_thong_so('td_a3');
	$ten_4=lay_thong_so('td_a4');
?>
<table width="990px" id="er" style="margin-top:6px">
	<tr>
		<td align="right">
			<span class="span__16">Sửa tên khung sản phẩm</span>
				...
				<form action="" method="post">
					<table width="976px" style="margin:6px">
						...
						<tr>
							...
							<td>
								<input type="hidden" name="bm_st_ksp" value="bm_st_ksp" >
